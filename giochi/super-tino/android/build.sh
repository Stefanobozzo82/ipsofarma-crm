...
$BT/aapt2 link -o out/base.apk -I $AJ --manifest proj/AndroidManifest.xml -A proj/assets --java out/gen out/res.zip --min-sdk-version 24 --target-sdk-version 34 --version-code 8 --version-name 1.7 -0 html

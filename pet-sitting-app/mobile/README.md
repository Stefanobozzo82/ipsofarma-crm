...
App React Native (Expo + Expo Router) per Fido. Copre il percorso principale del **proprietario**: login/registrazione, ricerca sitter, richiesta Meet & Greet, prenotazione, pagamento Stripe, gestione animali, candidatura come sitter — vedi [`docs/PHASE1-PROPOSAL.md`](../docs/PHASE1-PROPOSAL.md) per la roadmap completa.
...
- Dashboard sitter (richieste in arrivo, calendario, guadagni), accept/decline prenotazione lato sitter, gestione listino/disponibilità da mobile

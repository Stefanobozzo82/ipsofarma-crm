...
/**
 * Porting 1:1 di mobile/src/features/chat/api.ts: parla direttamente con
 * Supabase (client + Realtime), non con il backend Express — vedi la nota
 * in supabase/migrations/20260812170000_chat.sql sul perché.
 */
...
/** Trova o crea la conversazione tra due parti — chi la apre dal profilo
 * pubblico di un sitter è sempre owner (il sito non ha ancora una vista
 * "dashboard sitter"). */

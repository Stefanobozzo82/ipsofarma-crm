...
Questa suite non attesta ancora le RPC documentali transazionali, concorrenza multi-sessione, API PostgREST reale, consegna email, pagamenti o flussi E2E. I criteri per estenderla sono in `../docs/STABILIZATION_AUDIT.md`. Non sono stati aggiunti workflow alla radice del repository: il perimetro autorizzato è `saas/`.
